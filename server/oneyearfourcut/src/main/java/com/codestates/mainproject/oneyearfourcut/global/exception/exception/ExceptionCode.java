...
public enum ExceptionCode {
    ...
    FOLLOW_NOT_FOUND_FROM_GALLERY(400, "해당 Gallery에 포함된 Follow가 아닙니다."),
    MEMBER_IS_NOT_FOLLOWING(400, "해당 유저는 팔로잉하지 않습니다" ),
    THIS_MEMBER_IS_NOT_FOLLOWER(400 , "팔로워가 아닙니다." ),
    CANNOT_FOLLOW(400, "Follow 할 수 없습니다." ),
    FOLLOW_NOT_FOUND(400, "해당 Follow가 존재 하지 않습니다." ),
